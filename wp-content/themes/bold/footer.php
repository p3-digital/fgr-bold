...
<footer id="footer">
	<div class="hidden-xs desktop-footer">
		...
		<div class="col-xs-12 col-sm-10 col-sm-offset-1 foot-middle">
			...
			<div class="col-xs-12 col-sm-6">
				<a class="pull-right go-to-top" href="#top"><img src="<?php echo get_template_directory_uri() . '/assets/img/red-star.png'; ?>" alt="Site logo"></a>
			</div>
		</div>
		<div class="col-xs-12">
	...
	<div class="hidden-sm hidden-md hidden-lg mobile-footer wrap">
		<p class="white text-center didot">are you ready to be bold?</p>
		<a href="/contact" class="transparent-white-btn uppercase">Contact Us</a>
		<div class="col-xs-12">
			<a class="go-to-top mobile-top" href="#top"><img src="<?php echo get_template_directory_uri() . '/assets/img/white-star.png'; ?>" alt="Site logo"></a>
		</div>
	</div>
</footer>
<?php wp_footer(); ?>
